...
public class Operation
{
    ...
    {
        var t = new Core.ExecutableParser("query name { foo }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("query name { foo : bar }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("query name { foo(bar: 3) }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("query name { foo(bar: $var) }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("query name { foo : bar(fizz: 3) @bar { foo2 : bar2(fizz2: 3) @bar2} }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("query name { ... bar }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("query name { ... bar @foo }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("query name { ... on foo { bar } }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("query name { ... on foo @fizz { bar } }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("query name { foo ... bar ... on fizz { buzz } }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.ExecutableParser("{ foo }");
        var documentNode = t.Parse();
