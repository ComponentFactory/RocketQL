...
public class ExtendEnumTypeDefinition
{
    ...
    {
        var t = new Core.Parser("extend enum foo { BUZZ }");
    ...
    {
        var t = new Core.Parser("extend enum foo @bar");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.Parser("extend enum foo @bar { BUZZ }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.Parser("extend enum foo 42");
        try
        {
            var documentNode = t.Parse();
        }
