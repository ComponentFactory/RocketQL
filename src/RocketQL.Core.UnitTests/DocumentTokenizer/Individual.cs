...
public class Individual
{
    ...
    {
        var t = new DocumentTokenizer("test", null);
    ...
    {
        var t = new DocumentTokenizer("test", text);
    ...
    [Theory]
    [InlineData("!", DocumentTokenKind.Exclamation)]
    [InlineData("$", DocumentTokenKind.Dollar)]
    [InlineData("&", DocumentTokenKind.Ampersand)]
    [InlineData("(", DocumentTokenKind.LeftParenthesis)]
    [InlineData(")", DocumentTokenKind.RightParenthesis)]
    [InlineData(":", DocumentTokenKind.Colon)]
    [InlineData("=", DocumentTokenKind.Equals)]
    [InlineData("@", DocumentTokenKind.At)]
    [InlineData("[", DocumentTokenKind.LeftSquareBracket)]
    [InlineData("]", DocumentTokenKind.RightSquareBracket)]
    [InlineData("{", DocumentTokenKind.LeftCurlyBracket)]
    [InlineData("}", DocumentTokenKind.RightCurlyBracket)]
    [InlineData("|", DocumentTokenKind.Vertical)]
    ...
    [Theory]
    [InlineData("0", 0, DocumentTokenKind.EndOfText)]
    [InlineData("9", 9, DocumentTokenKind.EndOfText)]
    [InlineData("12345", 12345, DocumentTokenKind.EndOfText)]
    ...
    [InlineData("0#", 0, DocumentTokenKind.EndOfText)]
    [InlineData("9\t", 9, DocumentTokenKind.EndOfText)]
    [InlineData("12345\r\n", 12345, DocumentTokenKind.EndOfText)]
    [InlineData("9876543,", 9876543, DocumentTokenKind.EndOfText)]
    [InlineData("-0{", -0, DocumentTokenKind.LeftCurlyBracket)]
    [InlineData("-0 {", -0, DocumentTokenKind.LeftCurlyBracket)]
    [InlineData("-9876543\uFEFF", -9876543, DocumentTokenKind.EndOfText)]
    ...
    [InlineData("9.1", 9.1, DocumentTokenKind.EndOfText)]
    [InlineData("12345.0123", 12345.0123, DocumentTokenKind.EndOfText)]
    [InlineData("9876543.987", 9876543.987, DocumentTokenKind.EndOfText)]
    [InlineData("-0.0", -0.0, DocumentTokenKind.EndOfText)]
    [InlineData("-9.1", -9.1, DocumentTokenKind.EndOfText)]
    [InlineData("-12345.0123", -12345.0123, DocumentTokenKind.EndOfText)]
    [InlineData("-9876543.987", -9876543.987, DocumentTokenKind.EndOfText)]
    [InlineData("1e0", 1e0, DocumentTokenKind.EndOfText)]
    [InlineData("2e123", 2e123, DocumentTokenKind.EndOfText)]
    [InlineData("1e+2", 1e+2, DocumentTokenKind.EndOfText)]
    [InlineData("2e+33", 2e+33, DocumentTokenKind.EndOfText)]
    [InlineData("1e-2", 1e-2, DocumentTokenKind.EndOfText)]
    [InlineData("2e-33", 2e-33, DocumentTokenKind.EndOfText)]
    [InlineData("1.1e0", 1.1e0, DocumentTokenKind.EndOfText)]
    [InlineData("2.2e123", 2.2e123, DocumentTokenKind.EndOfText)]
    [InlineData("1.1e+2", 1.1e+2, DocumentTokenKind.EndOfText)]
    [InlineData("2.2e+33", 2.2e+33, DocumentTokenKind.EndOfText)]
    [InlineData("1.1e-2", 1.1e-2, DocumentTokenKind.EndOfText)]
    [InlineData("2.2e-33", 2.2e-33, DocumentTokenKind.EndOfText)]
    [InlineData("0.0 ", 0.0, DocumentTokenKind.EndOfText)]
    [InlineData("9.1#", 9.1, DocumentTokenKind.EndOfText)]
    [InlineData("12345.0123\r\n", 12345.0123, DocumentTokenKind.EndOfText)]
    [InlineData("9876543.987{", 9876543.987, DocumentTokenKind.LeftCurlyBracket)]
    [InlineData("-0.0﻿\uFEFF", -0.0, DocumentTokenKind.EndOfText)]
