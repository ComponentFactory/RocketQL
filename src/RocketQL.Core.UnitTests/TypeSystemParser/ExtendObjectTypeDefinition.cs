...
public class ExtendObjectTypeDefinition
{
    ...
    {
        var t = new Core.TypeSystemParser("extend type foo { bar: Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("extend type foo { bar: Integer @fizz }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("extend type foo { bar(hello: Integer = 3): Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("extend type foo { bar: Integer fizz: String }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("extend type foo @bar");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("extend type foo 42");
        try
        {
            var documentNode = t.Parse();
        }
