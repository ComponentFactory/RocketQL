...
public class ExtendSchema
{
    ...
    {
        var t = new Core.TypeSystemParser("extend schema @bar");
    ...
    {
        var t = new Core.TypeSystemParser("extend schema { query: bar }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("extend schema @bar { query: bar }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("extend schema 42");
        try
        {
            var documentNode = t.Parse();
        }
