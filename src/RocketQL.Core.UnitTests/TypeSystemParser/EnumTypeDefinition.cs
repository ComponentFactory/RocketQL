...
public class EnumTypeDefinition
{
    ...
    public void OneEnum()
    {
        var t = new Core.TypeSystemParser("enum foo { BUZZ }");
    ...
    {
        var t = new Core.TypeSystemParser("enum foo { FIZZ BUZZ }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("enum foo { FIZZ BUZZ LAST }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("enum foo @bar { BUZZ @fizz }");
        var documentNode = t.Parse();
