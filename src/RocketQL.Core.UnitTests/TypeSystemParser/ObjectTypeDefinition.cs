...
public class ObjectTypeDefinition
{
    ...
    public void Minimum()
    {
        var t = new Core.TypeSystemParser("type foo");
    ...
    {
        var t = new Core.TypeSystemParser("type foo { bar: Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("type foo { bar: Integer @fizz }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("type foo { bar(hello: Integer = 3): Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("type foo { bar: Integer fizz: String }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("type foo @bar");
        var documentNode = t.Parse();
