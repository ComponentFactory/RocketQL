...
public class Directive
{
    ...
    {
        var t = new Core.TypeSystemParser("directive @foo (bar: fizz @hello (world: 3)) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("directive @foo (bar: fizz @hello (world: 3, second: true)) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("directive @foo (bar: fizz @hello @world) on ENUM");
        var documentNode = t.Parse();
