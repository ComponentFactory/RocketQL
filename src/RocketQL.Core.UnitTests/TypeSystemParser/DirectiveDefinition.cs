...
public class DirectiveDefinition
{
    ...
    {
        var t = new Core.TypeSystemParser($"directive @foo on {location}");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser($"directive @foo on {str}");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("directive @foo (bar: fizz) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("directive @foo (bar: fizz = 3.14) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.TypeSystemParser("directive @foo (bar: fizz @hello) on ENUM");
        var documentNode = t.Parse();
