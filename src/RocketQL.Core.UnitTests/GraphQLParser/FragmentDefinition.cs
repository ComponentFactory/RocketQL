...
public class FragmentDefinition
{
    ...
    public void Minimal()
    {
        var t = new Core.GraphQLParser("fragment foo on bar { fizz }");
    ...
    {
        var t = new Core.GraphQLParser("fragment foo on bar @buzz { fizz }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("fragment on");
        try
        {
            var documentNode = t.Parse();
        }
