...
public class Directive
{
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (bar: fizz @hello) on ENUM");
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (bar: fizz @hello (world: 3)) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (bar: fizz @hello (world: 3, second: true)) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (bar: fizz @hello @world) on ENUM");
        var documentNode = t.Parse();
    ...
    [Theory]
    [InlineData("directive @foo (bar: fizz @42", GraphQLTokenKind.Name, GraphQLTokenKind.IntValue)]
    [InlineData("directive @foo (bar: fizz @hello 42", GraphQLTokenKind.RightParenthesis, GraphQLTokenKind.IntValue)]
    [InlineData("directive @foo (bar: fizz @hello (42", GraphQLTokenKind.Name, GraphQLTokenKind.IntValue)]
    [InlineData("directive @foo (bar: fizz @hello (world 42", GraphQLTokenKind.Colon, GraphQLTokenKind.IntValue)]
    [InlineData("directive @foo (bar: fizz @hello (world: 42 43", GraphQLTokenKind.Name, GraphQLTokenKind.IntValue)]
