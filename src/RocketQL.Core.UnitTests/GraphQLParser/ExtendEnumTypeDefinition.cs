...
public class ExtendEnumTypeDefinition
{
    ...
    {
        var t = new Core.GraphQLParser("extend enum foo { BUZZ }");
    ...
    {
        var t = new Core.GraphQLParser("extend enum foo @bar");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("extend enum foo @bar { BUZZ }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("extend enum foo 42");
        try
        {
            var documentNode = t.Parse();
        }
