...
public class ExtendInterfaceTypeDefinition
{
    ...
    {
        var t = new Core.GraphQLParser("extend interface foo { bar: Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("extend interface foo { bar: Integer @fizz }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("extend interface foo { bar(hello: Integer = 3): Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("extend interface foo { bar: Integer fizz: String }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("extend interface foo @bar");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("extend interface foo 42");
        try
        {
            var documentNode = t.Parse();
        }
