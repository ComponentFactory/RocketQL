...
public class ObjectTypeDefinition
{
    ...
    public void Minimum()
    {
        var t = new Core.GraphQLParser("type foo");
    ...
    {
        var t = new Core.GraphQLParser("type foo { bar: Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("type foo { bar: Integer @fizz }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("type foo { bar(hello: Integer = 3): Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("type foo { bar: Integer fizz: String }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("type foo @bar");
        var documentNode = t.Parse();
