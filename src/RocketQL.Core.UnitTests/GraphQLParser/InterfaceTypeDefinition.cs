...
public class InterfaceTypeDefinition
{
    ...
    public void Minimum()
    {
        var t = new Core.GraphQLParser("interface foo");
    ...
    {
        var t = new Core.GraphQLParser("interface foo { bar: Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("interface foo { bar: Integer @fizz }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("interface foo { bar(hello: Integer = 3): Integer }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("interface foo { bar: Integer fizz: String }");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("interface foo @bar");
        var documentNode = t.Parse();
