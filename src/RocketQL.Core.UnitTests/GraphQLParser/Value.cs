...
public class Value
{
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = 1) on ENUM");
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = 3.14159) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = \"word\") on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser($"directive @foo (fizz: buzz = {value.ToString().ToLower()}) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = null) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = ORANGE) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = []) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = [3]) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = [3 [4]]) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = [3 { hello: null }]) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = { world: 42 }) on ENUM");
        var documentNode = t.Parse();
    ...
    {
        var t = new Core.GraphQLParser("directive @foo (fizz: buzz = { world: { hello: 42 } }) on ENUM");
        var documentNode = t.Parse();
    ...
    [Theory]
    [InlineData("directive @foo (fizz: buzz = { world: $ }) on ENUM", GraphQLTokenKind.Dollar)]
    [InlineData("directive @foo (fizz: buzz = { world: @ }) on ENUM", GraphQLTokenKind.At)]
    [InlineData("directive @foo (fizz: buzz = { world: : }) on ENUM", GraphQLTokenKind.Colon)]
    [InlineData("directive @foo (fizz: buzz = { world: ... }) on ENUM", GraphQLTokenKind.Spread)]
    public void TokenNotAllowedHere(string text, GraphQLTokenKind tokenKind)
    {
