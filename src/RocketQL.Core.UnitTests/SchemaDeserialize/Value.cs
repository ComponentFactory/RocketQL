...
public class Value
{
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = 1) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = 3.14159) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = \"word\") on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize($"directive @foo (fizz: buzz = {value.ToString().ToLower()}) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = null) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = ORANGE) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = []) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = [3]) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = [3 [4]]) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = [3 { hello: null }]) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = { world: 42 }) on ENUM");
    ...
    {
        var documentNode = Document.SchemaDeserialize("directive @foo (fizz: buzz = { world: { hello: 42 } }) on ENUM");
