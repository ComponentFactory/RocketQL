...
public class ExtendObjectTypeDefinition
{
    ...
    {
        var documentNode = Serialization.SchemaDeserialize("test", "extend type foo { bar: Integer }");
    ...
    {
        var documentNode = Serialization.SchemaDeserialize("test", "extend type foo { bar: Integer @fizz }");
    ...
    {
        var documentNode = Serialization.SchemaDeserialize("test", "extend type foo { bar(hello: Integer = 3): Integer }");
    ...
    {
        var documentNode = Serialization.SchemaDeserialize("test", "extend type foo { bar: Integer fizz: String }");
    ...
    {
        var documentNode = Serialization.SchemaDeserialize("test", "extend type foo @bar");
    ...
    public void ExtendObjectTypeMissingAtLeastOne()
    {
        try
        {
            var documentNode = Serialization.SchemaDeserialize("test", "extend type foo 42");
        }
        catch (SyntaxException ex)
        {
