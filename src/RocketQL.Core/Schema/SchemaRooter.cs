...
{
    private SchemaRooter? _schemaRoot = null;
    private SchemaRooter Rooter => _schemaRoot ??= new SchemaRooter(this);

    private class SchemaRooter(Schema schema) : ISchemaNodeVisitors
    {
