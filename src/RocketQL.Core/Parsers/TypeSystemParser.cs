...
public ref struct TypeSystemParser
{
    private DocumentTokenizer _tokenizer;
    private string? _description = null;

    public TypeSystemParser(ReadOnlySpan<char> text)
    {
        _tokenizer = new DocumentTokenizer(text);
    }

    public TypeSystemDocumentNode Parse()
    {
        ...
        return new TypeSystemDocumentNode(_directives,
