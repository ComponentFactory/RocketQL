...
public ref struct ExecutableParser
{
    private DocumentTokenizer _tokenizer;
    private string? _description = null;

    public ExecutableParser(ReadOnlySpan<char> text)
    {
        _tokenizer = new DocumentTokenizer(text);
    }

    public ExecutableDocumentNode Parse()
    {
        ...
        return new ExecutableDocumentNode(_operations, _fragments);
    }
