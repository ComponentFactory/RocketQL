...
public class ValidationException(Location location, string message) : RocketException(location, message)
{
    ...
    public static ValidationException ValueNotCompatibleWithType(SchemaNode node, SchemaNode parentNode, SchemaNode argumentNode) => new(node.Location, $"{argumentNode.OutputElement} '{argumentNode.OutputName}' of {node.OutputElement.ToLower()} '{node.OutputName}' of {parentNode.OutputElement.ToLower()} '{parentNode.OutputName}' has a default value incompatible with the type.");
    public static ValidationException ValueNotCompatibleWithType(SchemaNode node, SchemaNode argumentNode) => new(node.Location, $"{argumentNode.OutputElement} '{argumentNode.OutputName}' of {node.OutputElement.ToLower()} '{node.OutputName}' has a default value incompatible with the type.");
    ...
    public static ValidationException DirectiveNotAllowedLocation(SchemaNode node, SchemaNode parentNode, params SchemaNode?[] extraNodes) => new(node.Location, $"{node.OutputElement} '{node.OutputName}' is not specified for use on {ExpandNodesOf(extraNodes)}{parentNode.OutputElement.ToLower()}{OptionalQuotedName(parentNode)} location.");
