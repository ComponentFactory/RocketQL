...
public ref struct SchemaDeserializer(ReadOnlySpan<char> text, string source)
{
    ...
    public SchemaDeserializer(ReadOnlySpan<char> text, [CallerFilePath] string filePath = "", [CallerMemberName] string memberName = "", [CallerLineNumber] int lineNumber = 0)
    ...
    private SyntaxSchemaDefinitionNode ParseSchemaDefinition()
    {
        ...
        while (_tokenizer.TokenKind != DocumentTokenKind.RightCurlyBracket)
        {
            ...
            var operationType = OperationTypeFromTokenValue();
            MandatoryNextToken(DocumentTokenKind.Colon);
            MandatoryNextToken(DocumentTokenKind.Name);
            var namedType = _tokenizer.TokenValue;
            MandatoryNext();
    ...
    private SyntaxScalarTypeDefinitionNode ParseScalarTypeDefinition()
    {
        ...
        return new SyntaxScalarTypeDefinitionNode(UseTopLevelDescription(), name, ParseDirectivesOptional(), location);
    }
    ...
    private SyntaxExtendObjectTypeDefinitionNode ParseExtendObjectTypeDefinition()
    {
        ...
        return new SyntaxExtendObjectTypeDefinitionNode(name, implementsIntefaces, directives, fieldSet, location);
    }
    ...
    private SyntaxExtendInterfaceTypeDefinitionNode ParseExtendInterfaceTypeDefinition()
    {
        ...
        return new SyntaxExtendInterfaceTypeDefinitionNode(name, implementsIntefaces, directives, fieldSet, location);
    }
    ...
    private SyntaxUnionTypeDefinitionNode ParseUnionTypeDefinition()
    {
        ...
        return new SyntaxUnionTypeDefinitionNode(UseTopLevelDescription(), name, ParseDirectivesOptional(), ParseMemberTypesOptional(), location);
    }
    ...
    private SyntaxExtendUnionTypeDefinitionNode ParseExtendUnionTypeDefinition()
    {
        ...
        return new SyntaxExtendUnionTypeDefinitionNode(name, directives, memberTypes, location);
    }
    ...
    private SyntaxEnumTypeDefinitionNode ParseEnumTypeDefinition()
    {
        ...
        return new SyntaxEnumTypeDefinitionNode(UseTopLevelDescription(), name, ParseDirectivesOptional(), ParseEnumValueTypesOptional(), location);
    }
    ...
    private SyntaxExtendEnumTypeDefinitionNode ParseExtendEnumTypeDefinition()
    {
        ...
        return new SyntaxExtendEnumTypeDefinitionNode(name, directives, enumValues, location);
    }
    ...
    private SyntaxInputObjectTypeDefinitionNode ParseInputObjectTypeDefinition()
    {
        ...
        {
            MandatoryTokenNext(DocumentTokenKind.LeftCurlyBracket);
            inputFields = ParseInputValueListDefinition(InputValueUsage.InputField);
            MandatoryToken(DocumentTokenKind.RightCurlyBracket);
            _tokenizer.Next();
        }

        return new SyntaxInputObjectTypeDefinitionNode(UseTopLevelDescription(), name, directives, inputFields ?? [], location);
    }
    ...
    private SyntaxExtendInputObjectTypeDefinitionNode ParseExtendInputObjectTypeDefinition()
    {
        ...
        return new SyntaxExtendInputObjectTypeDefinitionNode(name, directives, inputFields ?? [], location);
    }
    ...
    private SyntaxDirectiveDefinitionNode ParseDirectiveDefinition()
    {
        ...
        return new SyntaxDirectiveDefinitionNode(UseTopLevelDescription(), "@" + name, arguments, repeatable, ParseDirectiveLocations(), location);
    }
    ...
    private SyntaxNameList ParseImplementsInterfacesOptional()
    {
        ...
        if (OptionalKeyword("implements"))
        {
            ...
            MandatoryToken(DocumentTokenKind.Name);
            list.Add(new SyntaxNameNode(_tokenizer.TokenValue, NameUsage.Interface, _tokenizer.Location));
            _tokenizer.Next();
    ...
    private SyntaxFieldDefinitionNodeList ParseFieldsOptionalDefinition()
    {
        ...
        if (_tokenizer.TokenKind == DocumentTokenKind.LeftCurlyBracket)
        {
            ...
            while (_tokenizer.TokenKind != DocumentTokenKind.RightCurlyBracket)
            {
                ...
                list.Add(new SyntaxFieldDefinitionNode(description ?? "", name, arguments, ParseType(), ParseDirectivesOptional(), location));
            }
    ...
    private SyntaxEnumValueDefinitionList ParseEnumValueTypesOptional()
    {
        ...
        if (_tokenizer.TokenKind == DocumentTokenKind.LeftCurlyBracket)
        {
            ...
            while (_tokenizer.TokenKind != DocumentTokenKind.RightCurlyBracket)
            {
                ...
                list.Add(new SyntaxEnumValueDefinition(description ?? "", name, ParseDirectivesOptional(), location));
            }
    ...
    private SyntaxNameList ParseMemberTypesOptional()
    {
        ...
        if (_tokenizer.TokenKind == DocumentTokenKind.Equals)
        {
            ...
            MandatoryToken(DocumentTokenKind.Name);
            list.Add(new SyntaxNameNode(_tokenizer.TokenValue, NameUsage.MemberType, _tokenizer.Location));
            _tokenizer.Next();
    ...
    private SyntaxInputValueDefinitionNodeList ParseArgumentsOptionalDefinition()
    {
        ...
        {
            MandatoryNext();
            var arguments = ParseInputValueListDefinition(InputValueUsage.Argument);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private SyntaxInputValueDefinitionNodeList ParseInputValueListDefinition(InputValueUsage usage)
    {
    ...
    private DirectiveLocations ParseDirectiveLocations()
    {
        ...
        OptionalToken(DocumentTokenKind.Vertical);
        MandatoryToken(DocumentTokenKind.Name);
        var directiveLocations = StringToDriveLocations(_tokenizer.TokenValue);
    ...
    private string? OptionalString()
    {
        ...
        {
            var ret = _tokenizer.TokenString;
            _tokenizer.Next();
            return ret;
        }
